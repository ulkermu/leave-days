  ...
  return (
    <header className="flex max-w-[1280px] w-full justify-between p-5">
      <nav className="flex items-center gap-2">
        {navLinks.map((link, key) => (
          <CustomNavLink
            ...
            href={link.href}
            icon={link.icon}
            containerStyles={`flex gap-1 items-center dark:hover:bg-slate-500 hover:bg-slate-100 ease-out duration-300 py-1 px-2 rounded-md font-bold ${
      ...
      <div className="flex gap-2 items-center">
        {user && (
          <button
            className="flex gap-1 items-center dark:hover:bg-slate-500 hover:bg-slate-100 ease-out duration-300 py-1 px-2 rounded-md font-bold"
            onClick={logout}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
